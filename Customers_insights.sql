...
select customer_id,round((avg(age)),2) as Averageage from customer
where can_email='yes'
group by customer_id;

'4. How many orders were made by customers aged 30 or older?'
select count(order_id) as ordersbycust from customer as c
join orders as o
...
select round(avg(price),2) as Avgprice,category
from products
where category='food';

'7. How many orders were made in each sales channel (sales_channel column) in the orders table?'

select count(o.order_id) as ordersbychannel, o.sales_channel
from orders as o
group by sales_channel;

'8.What is the date of the latest order made by a customer who can receive marketing emails?'

select o.date_shop, c.customer_id, o.order_id from customer as c
join orders as o
on c.customer_id= o.customer_id
where can_email='yes'
...
select count(order_id) as totalorders,country_name
from orders as o
join country as c
...
select round(avg(age),2) as avgage,c.customer_id from customer as c
join orders as o
on c. customer_id=o.customer_id
join baskets as b
